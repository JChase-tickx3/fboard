...
/* ==========================================================================
   3. МОДУЛЬ ФОРМЫ (TransactionForm)
   ========================================================================== */
class TransactionForm {
  ...
  initEvents() {
    // Кастомная маска для ввода мобильного телефона
...
/* ==========================================================================
   4. УПРАВЛЕНИЕ ДАШБОРДОМ (Dashboard)
   ========================================================================== */
class Dashboard {
  ...
  updateDashboard() {
    ...
    // Логика кастомной фильтрации (по ТЗ)
    ...
    // Расчет сводной статистики (всегда считается по общему хранилищу)
...
/* ==========================================================================
   5. ИНИЦИАЛИЗАЦИЯ И СИСТЕМА РОУТИНГА (SPA)
   ========================================================================== */
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Роутинг без перезагрузки страниц
  ...
  // Логика управления кастомным модальным окном <dialog>
